...
class PerfilSesionSql:
    ...
    POR_ID = (
        ...
        "ssd_gb_min, capacidad_litros_min, nombre_excluye_acum, presupuesto_ideal, presupuesto_min_buscado, frustracion_count, "
        "ultimos_skus_mostrados, precio_min_mostrado, precio_max_mostrado, "
        "alternativa_ofrecida, ciudad_sesion, updated_at "
    ...
    UPSERT = (
        ...
        " resolucion, ram_gb_min, gpu_dedicada, ssd_gb_min, capacidad_litros_min, nombre_excluye_acum, presupuesto_ideal, "
        " presupuesto_min_buscado, frustracion_count, ciudad_sesion) "
        "VALUES (:sid, :pmax, :marca, :cat, :subcat, :sku, :gen, :tier, :uso, :pulg, "
        "        :panel, :res, :ram, :gpu, :ssd, :litros_min, :excluye, :pideal, :pmin_buscado, :frust, :ciudad) "
